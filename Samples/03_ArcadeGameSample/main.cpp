...
{
#ifdef USING_OPENGL
const char*		szWindowTitle = "Universal - Interface Library - ArcadeGame sample [OpenGL]";
#else
const char*		szWindowTitle = "Universal - Interface Library - ArcadeGame sample [DirectX9]";
#endif
...
void	MainUpdate( void )
{
	...
	// Draw stuff here
	InterfaceText( 0, 10, 10, "Arcade game sample", 0xFFFFFFFF, 1 );

	InterfaceTextCenter( 0, 0, InterfaceGetWidth(), 200, "Under Construction", 0xF0D04010, 0 );
