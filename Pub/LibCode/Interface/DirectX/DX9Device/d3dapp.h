...
struct D3DDeviceInfo
{
    ...
    GRAPHICSCAPS     d3dCaps;         // Capabilities of this device
...
{
    // Adapter data
    GRAPHICSADAPTER_IDENTIFIER d3dAdapterIdentifier;
...
{
public:
    LPGRAPHICS       m_pD3D;              // The main D3D object
    LPGRAPHICSDEVICE m_pd3dDevice;        // The D3D rendering device
    BOOL              m_bWindowed;
	...
	HRESULT InitD3DMinimal( HWND hwind );
...
protected:
    ...
    GRAPHICSCAPS      m_d3dCaps;           // Caps for the device
    ...
    virtual HRESULT ConfirmDevice(GRAPHICSCAPS*,DWORD,D3DFORMAT)   { return S_OK; }
...
public:
    ...
    virtual HRESULT Create(  HWND hwind  );
    virtual INT     Run();
