...
#ifndef ENGINE_SKINNEDMESH_LOADER_H
#define	ENGINE_SKINNEDMESH_LOADER_H
...
extern HRESULT LoadMeshHierarchy( SkinnedMeshDX* pSkinnedMeshDX, const char* szFilename );
...
{
    ID3DXMesh *pMesh;
    GRAPHICSMATERIAL *rgMaterials;
    LPGRAPHICSTEXTURE *pTextures;
    DWORD cpattr;
    DWORD cMaterials;
    DWORD iAttrSplit;
