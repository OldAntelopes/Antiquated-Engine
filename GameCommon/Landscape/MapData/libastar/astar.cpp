...
//                           N    NE    E    SE     S    SW     W    NW
static const int _dx[8] = {   0,    1,   1,    1,    0,   -1,   -1,   -1 };
static const int _dy[8] = {  -1,   -1,   0,    1,    1,    1,    0,   -1 };
static const int _mc[8] = {  CC,   CD,  CC,   CD,   CC,   CD,   CC,   CD };
...
void
astar_set_dxy (astar_t *as, const BYTE dir, const int dx, const int dy)
{
        assert (as != NULL);
        as->dx[dir & 7] = dx;
        as->dy[dir & 7] = dy;
