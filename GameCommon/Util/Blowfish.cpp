...
void BlowfishEncrypt(uchar in[], uchar out[], BLOWFISH_KEY *keystruct)
{
   uint l,r,t;
...
void BlowfishDecrypt(uchar in[], uchar out[], BLOWFISH_KEY *keystruct)
{
   uint l,r,t;
...
void BlowfishSetKey( const BYTE* user_key, int len, BLOWFISH_KEY *keystruct )
{
   ...
   for (idx = 0; idx < 18; idx += 2) {
      BlowfishEncrypt(block,block,keystruct);
