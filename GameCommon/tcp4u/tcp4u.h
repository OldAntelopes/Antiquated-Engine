...
int   API4U Tcp4uVer (char* szInfo, UINT uBufSize);
char* API4U Tcp4uErrorString (int Rc);
void  API4U Tcp4uEnableLog (unsigned uMask);
void  API4U Tcp4uDump (const char* cp, int nLen, const char* szPrefix);
/* ------------------------------------------------- */
/* TCP functions                                     */   
/* ------------------------------------------------- */
int API4U TcpAbort (void);
int API4U TcpAccept (SOCKET *pCSock, SOCKET ListenSock, UINT nTO, struct sockaddr_in* );
int API4U TcpConnect (SOCKET *pS, const char* szServer, const char* szService, unsigned short *lpPort);
int API4U TcpClose (SOCKET *pS);
int API4U TcpFlush (SOCKET s);
int API4U TcpGetListenSocket (SOCKET *pS, const char* szService, unsigned short *lpPort, int nPendingConnection);
int API4U TcpRecv (SOCKET s, char* szBuf, unsigned uBufSize, unsigned uTimeOut, HFILE hf);
int API4U TcpSend (SOCKET s, const char* szBuf, unsigned uBufSize, BOOL bHighPriority, HFILE hf);
int API4U TcpGetLocalID (char* szStrName, int uNameSize, DWORD *lpAddress);
int API4U TcpGetRemoteID (SOCKET s, char* szStrName, int uNameSize, DWORD *lpAddress);
BOOL API4U TcpIsDataAvail (SOCKET s);
BOOL API4U TcpIsOOBDataAvail (SOCKET s);
/* PP protocole (2 first bytes contain length of data) */
int API4U TcpPPRecv (SOCKET s, char* szBuf, unsigned uBufSize, unsigned uTimeOut, 
                     BOOL bExact, HFILE hLogFile);
int API4U TcpPPSend (SOCKET s, const char* szBuf, unsigned uBufSize, HFILE hLogFile);
/* Recv Until family */
int API4U TcpRecvUntilStr (SOCKET s, char* szBuf,unsigned *lpBufSize,
                          char* szStop, unsigned uStopSize, BOOL bCaseSensitive,
...
int API4U TcpRecvUntilClosedEx (SOCKET       *pCSock,     const char* szLocalFile, 
...
/* Telnet functions                                  */   
/* ------------------------------------------------- */
int API4U TnReadMultiLine (SOCKET s, char* szBuf, UINT BufSize, UINT uTimeOut, HFILE hf);
int API4U TnReadLine (SOCKET s, char* szBuf, UINT BufSize, UINT uTimeOut, HFILE hf);
int API4U TnSendMultiLine (SOCKET s, const char* szString, BOOL bEnd, HFILE hf);
int API4U TnSend (SOCKET s, const char* szString, BOOL bHighPriority, HFILE hf);
int API4U TnGetAnswerCode(SOCKET s, char* szInBuf,UINT uBufSize,UINT uTimeOut, HFILE hf);
/* ------------------------------------------------- */
...
int   API4U Tcp4wVer (char* szInfo, UINT uBufSize);
char* API4U Tcp4wErrorString (int Rc);
#ifdef __cplusplus     
}  /* End of extern "C" */   
